                        ...
                        <form action="enhanced-results.html">
                            <div class="row" style="padding: 10px">
                                ...
                                <div class="col-md-0 ml-auto">
                                    <button type="submit" class="btn btn-primary">Novo Gerente</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center"><button type="submit" class="btn btn-success btn-sm rounded-0">Ativo</button></td>
